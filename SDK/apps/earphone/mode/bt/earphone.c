...
static int bt_connction_status_event_handler(struct bt_event *bt)
{
    ...
    extern u8 hjx_get_channel_by_code_or_res(void);
    hjx_get_channel_by_code_or_res();
