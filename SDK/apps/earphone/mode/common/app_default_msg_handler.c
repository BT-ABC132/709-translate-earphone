...
static void app_common_app_event_handler(int *msg)
{
    ...
    case APP_MSG_SPATIAL_EFFECT_SWITCH:
        ...
        break;
#endif
    case APP_MSG_HJX_OPEN_MIC_OPUS:
        printf("---APP_MSG_HJX_OPEN_MIC_OPUS:%d\n",msg[1]);
        hjx_open_opus_fun(msg[1],1);
        break;
    case APP_MSG_HJX_OPEN_STUDIO_NO_OPUS:
        printf("---APP_MSG_HJX_OPEN_STUDIO_NO_OPUS:%d\n",msg[1]);
        hjx_open_studio_no_opus_fun(msg[1]);
        break;
    case APP_MSG_HJX_CLOSE_MIC_OPUS:
        printf("---APP_MSG_HJX_CLOSE_MIC_OPUS\n");
        hjx_close_opus_all();
        break;
    case APP_MSG_HJX_PLAY_OPUS:
        printf("---APP_MSG_HJX_PLAY_OPUS\n");
        hjx_play_opus_fun(1);
        break;
    case APP_MSG_HJX_STOP_PLAY_OPUS:
        printf("---APP_MSG_HJX_STOP_PLAY_OPUS\n");
        hjx_play_opus_fun(0);
        break;
    case APP_MSG_TWS_CONNECT:
        printf("---APP_MSG_TWS_CONNECT\n");
        hjx_tws_dis_flag=0;
        tws_dual_conn_state_handler();
        break;
    case APP_MSG_TWS_DISCONNECT:
        printf("---APP_MSG_TWS_DISCONNECT\n");
    #if 0
        hjx_bt_page_scan_for_test(1);
        /*
    ...
    #endif
        break;
    case APP_MSG_HJX_BLE_MAC:
        printf("---APP_MSG_HJX_BLE_MAC\n");
        bt_tws_sync_ble_mac();
        break;
    case APP_MSG_HJX_VM_BLE_MAC2:
        printf("---APP_MSG_HJX_VM_BLE_MAC2\n");
        syscfg_write(HJX_VM_BLE_MAC2_INFO, hjx_ble_mac_buf2, 6);
        break;
    case APP_MSG_HJX_APP_SEND_OPUS_FLOW:
        printf("---APP_MSG_HJX_APP_SEND_OPUS_FLOW:%d\n",msg[1]);
        ///流控
        app_send_data_buf[0]=HJX_APP_HEAD_1;
        app_send_data_buf[1]=HJX_APP_HEAD_2;
        app_send_data_buf[2]=HJX_APP_CMD_APP_SEND_OPUS_FLOW;
        app_send_data_buf[3]=1;
        app_send_data_buf[4]=0;
        app_send_data_buf[5]=msg[1];
        app_send_data_buf[6]=send_dat_total_fun(app_send_data_buf,6);
        hjx_custom_ble_data_send(app_send_data_buf,7);                     
        break;
    default:
        break;
    }
