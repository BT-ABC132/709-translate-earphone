...
enum {
    ...
    APP_MSG_HJX_OPEN_MIC_OPUS,
    APP_MSG_HJX_CLOSE_MIC_OPUS,
    APP_MSG_HJX_PLAY_OPUS,
    APP_MSG_HJX_STOP_PLAY_OPUS,
    APP_MSG_TWS_CONNECT,
    APP_MSG_TWS_DISCONNECT,
    APP_MSG_HJX_BLE_MAC,
    APP_MSG_HJX_VM_BLE_MAC2,
    APP_MSG_HJX_OPEN_STUDIO_NO_OPUS,
    APP_MSG_HJX_APP_SEND_OPUS_FLOW,
};
