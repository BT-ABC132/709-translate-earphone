...
const uint8_t rcsp_profile_data[] = {
    ...
    //////////////////////////////////////////////////////
    //
    // 0x000a PRIMARY_SERVICE  FF00
    //
    //////////////////////////////////////////////////////
    0x0a, 0x00, 0x02, 0x00, 0x0a, 0x00, 0x00, 0x28, 0x00, 0xff,

     /* CHARACTERISTIC,  FF01, WRITE | WRITE_WITHOUT_RESPONSE | DYNAMIC, */
    // 0x000b CHARACTERISTIC FF01 WRITE | WRITE_WITHOUT_RESPONSE | DYNAMIC
    0x0d, 0x00, 0x02, 0x00, 0x0b, 0x00, 0x03, 0x28, 0x0c, 0x0c, 0x00, 0x01, 0xff,
    // 0x000c VALUE FF01 WRITE | WRITE_WITHOUT_RESPONSE | DYNAMIC
    0x08, 0x00, 0x0c, 0x01, 0x0c, 0x00, 0x01, 0xff,

     /* CHARACTERISTIC,  FF02, NOTIFY, */
    // 0x000d CHARACTERISTIC FF02 NOTIFY
    0x0d, 0x00, 0x02, 0x00, 0x0d, 0x00, 0x03, 0x28, 0x10, 0x0e, 0x00, 0x02, 0xff,
    // 0x000e VALUE FF02 NOTIFY
    0x08, 0x00, 0x10, 0x00, 0x0e, 0x00, 0x02, 0xff,
